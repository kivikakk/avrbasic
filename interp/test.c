...
void test_token_type(test_batch_runner *runner) {
  ...
  INT_EQ(runner, get_token_type('=', &label), T_BINOP, "get_token_type '=', T_LABEL");
...
void test_tokenize(test_batch_runner *runner) {
  ...
  INT_EQ(runner, type, T_BINOP, "tokenize 3.1");
...
void test_tokenize_string(test_batch_runner *runner) {
  ...
  INT_EQ(runner, type, T_BINOP, "tokenize_string 3.1");
  ...
  INT_EQ(runner, type, T_BINOP, "tokenize_string 5.1");
...
void test_exec_expr(test_batch_runner *runner) {
  ...
  value = exec_expr("1");
  INT_EQ(runner, value.type, V_NUMBER, "exec_expr value.type");
  INT_EQ(runner, value.as.number, 1, "exec_expr value.as.number");
}
